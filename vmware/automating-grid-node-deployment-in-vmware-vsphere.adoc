...
* Recolheu todas as informações necessárias para o ficheiro de configuração. Consulte xref:collecting-information-about-your-deployment-environment.adoc[Colete informações sobre seu ambiente de implantação] para obter informações.
...
xref:navigating-to-grid-manager.adoc[Navegue até o Gerenciador de Grade]
