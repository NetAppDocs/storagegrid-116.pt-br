...
+
Os arquivos de firmware da unidade têm um nome de arquivo semelhante ao
...
xref:upgrading-santricity-os-on-storage-controllers.adoc[Atualizar o SANtricity os em controladores de storage]
