...
* Se o dispositivo StorageGRID estiver em execução em um sistema StorageGRID, o controlador SG6000-CN xref:placing-appliance-into-maintenance-mode.adoc[colocado no modo de manutenção]foi .
+
