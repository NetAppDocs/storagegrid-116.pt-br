...
Se pretender alterar a configuração da ligação, consulte o xref:changing-link-configuration-of-sg6000-cn-controller.adoc[Instruções para alterar a configuração do link do controlador SG6000-CN].
