...
.Passos
. Selecione *CONFIGURATION* > *Network* > *VLAN interfaces*.
. Marque a caixa de seleção da interface VLAN que deseja editar. Em seguida, selecione *ações* > *Editar*.
...
.Passos
. Selecione *CONFIGURATION* > *Network* > *VLAN interfaces*.
. Marque a caixa de seleção para cada interface VLAN que deseja remover. Em seguida, selecione *ações* > *Excluir*.
