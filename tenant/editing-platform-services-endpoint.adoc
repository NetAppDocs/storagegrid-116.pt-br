...
* Você deve pertencer a um grupo de usuários que tenha a permissão Gerenciar Endpoints. xref:tenant-management-permissions.adoc[Permissões de gerenciamento do locatário]Consulte .
