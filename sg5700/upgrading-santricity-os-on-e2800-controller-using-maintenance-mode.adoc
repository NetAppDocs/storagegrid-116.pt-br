...
* Você deve colocar o controlador E5700SG no xref:placing-appliance-into-maintenance-mode.adoc[modo de manutenção], o que interrompe a conexão com o controlador E2800.
+
