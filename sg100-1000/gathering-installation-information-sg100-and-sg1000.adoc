...
image::../media/sg100_rj_45_ports_circled.png[sg100 portas rj 45 circuladas]
...
xref:sg100-and-sg1000-appliances-overview.adoc[Visão geral dos aparelhos SG100 e SG1000]

xref:cabling-appliance-sg100-and-sg1000.adoc[Aparelho de cabo SG100 e SG1000]

xref:configuring-storagegrid-ip-addresses-sg100-and-sg1000.adoc[Configurar endereços IP do StorageGRID]
