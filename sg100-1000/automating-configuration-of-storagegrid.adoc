...
NOTE: Também pode configurar o sistema utilizando a xref:../admin/index.adoc[Gerenciador de grade] ou a xref:overview-of-installation-rest-apis.adoc[API de instalação].
