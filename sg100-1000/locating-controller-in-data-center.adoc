...
* (Opcional) para ajudar a localizar o controlador no seu data centerxref:turning-controller-identify-led-on-and-off.adoc[Ligue o LED de identificação azul], .
