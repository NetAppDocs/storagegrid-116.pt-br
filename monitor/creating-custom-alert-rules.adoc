...
* Você está familiarizado com o. xref:commonly-used-prometheus-metrics.adoc[Métricas de Prometheus comumente usadas]
* Você entende https://prometheus.io/docs/querying/basics/["Sintaxe das consultas Prometheus"^]
* Opcionalmente, você assistiu ao vídeo: https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=b35ac3f2-957b-4e79-b82b-acc5013c98d0["Vídeo: Usando métricas para criar alertas personalizados"^]
+
