...
. Verifique o nome do host que você inseriu. Se você inseriu um endereço IP, verifique se ele é um endereço IP válido na notação W.X.Y.Z ("decimal pontilhado").
